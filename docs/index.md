...
A schema or profile in an open pull request is not an immutable protected release. A standards name in documentation is not conformance or certification evidence. Buyer- and integrator-facing claims should be backed by the current protected revision and the applicable immutable release, fixture, and CI evidence.
