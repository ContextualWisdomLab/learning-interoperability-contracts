...
- An exact two-valid/twelve-invalid protocol-binding fixture inventory covering valid xAPI 2.0, valid cmi5 Quartz, missing or changed contract identity, missing normative authority or immutable cmi5 revision, missing or changed xAPI and xAPI Profile format versions, cross-version claims in both directions, unknown surfaces, and statement-payload leakage; each invalid fixture is bound to its intended schema keyword and instance path.
